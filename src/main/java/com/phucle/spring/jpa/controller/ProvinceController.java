...
public class ProvinceController {
	...
	public String saveProvince(@Valid @ModelAttribute("province") Province theProvince,
		...
		if (theBindingResult.hasErrors()) {
			...
			List<Province> check = provinceService.getAll();
			for(Province pro : check) {
				if(pro.getName().equals(theProvince.getName())){
